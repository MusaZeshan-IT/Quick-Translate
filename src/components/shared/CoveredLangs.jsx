    ...
    return (
        <div className='flex lg:flex-row flex-col xl:gap-x-14 lg-custom:gap-x-20 lg:gap-x-16 gap-y-10'>
            <div className='lg-custom:w-4/12 lg:w-[35%]'>
                ...
                <h2 className='text-[rgb(19,40,126)] text-3xl font-black mt-3 xs-custom:xs-custom:w-[500px] leading-10'>Languages We Cover</h2>
            ...
            <div className='lg-custom:w-8/12 lg:w-[65%] overflow-hidden grid sm-custom:grid-cols-2 gap-y-12 xl:gap-x-10 mt-5'>
                <Lang
                    imgUrl={AmericanFlag}
