    ...
    return (
        <nav>
            <div className='h-20 flex justify-between items-center'>
                ...
                <div className='flex items-center lg-custom:gap-x-12 lg:gap-x-10 gap-x-5'>
                    <div className='lg:flex hidden lg-custom:gap-x-7 gap-x-6 text-sm font-semibold tracking-[1.8px]'>
